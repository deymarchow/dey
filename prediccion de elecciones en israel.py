...
column=D_israel.Balad     #en esta linea extraigo una columna de la base de datos de israel
                        #la guardo en una variable en tipo ista.  


p=column.remove('0')   #para esta linea deceo remover los " ceros" (0) de la columna seleccionada pero me lanza un error
